...
const handleCheck = (event) => {
  ...
  if (event.target.checked) {
    filterOptions = [...checked, event.target.value];
  } else {
    filterOptions.splice(checked.indexOf(event.target.value), 1);
  }
  ...
  return (
    <>
      ...
      <div className="relative z-50">
        ...
        >
          <DropdownItem tag="a" href="#" className="justify-between">
            <Label check>
              <Input
                ...
                checked={checkedItems.indexOf("analyst") !== -1}
              />
          ...
          <DropdownItem tag="a" href="#" className="justify-between">
            <Label check>
              <Input
                ...
                value="Full"
                onChange={handleCheck}
                checked={checkedItems.indexOf("Full") !== -1}
              />
              <span className="ml-2">Full Match</span>
            </Label>
          </DropdownItem>
          <DropdownItem>
            <Label check>
          ...
          <DropdownItem>
            <Label check>
              <Input type="checkbox" onChange={handleCheck} />
              <span className="ml-2">Freekick</span>
            </Label>
          </DropdownItem>
        </Dropdown>
      </div>
      ...
      <div className="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
        {v &&
          v
            // .filter((n) => n.type === "Full" && "analyst")
            .filter((items) =>
              items.type.split(",").some((size) => checkedItems.includes(size)) && items.win_lose==="lose"
            )
            .map((m) => (
              <div key={m.id}>
                <Card>
